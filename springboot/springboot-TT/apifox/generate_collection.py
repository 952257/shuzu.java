    ...
    "item": [
        ...
        folder(
            ...
            [
                ...
                req("物业-2修改", "POST", "/property.updateProperty",
                    body={"storeId": "{{caseStoreId}}", "name": "用例物业-改", "tel": "13800000001"}),
                req("物业-3删除", "POST", "/property.deleteProperty",
                ...
                req("小区-2修改", "POST", "/community.updateCommunity",
                    body={"communityId": "{{caseCommunityId}}", "name": "用例小区-改", "address": "西宁市城西区", "nearbyLandmarks": "中心广场"}),
                req("小区-3删除", "POST", "/community.deleteCommunity",
                ...
                req("楼栋-2修改", "POST", "/floor.editFloor",
                    body={"floorId": "{{caseFloorId}}", "name": "用例楼栋-改"}),
                req("楼栋-3删除", "POST", "/floor.deleteFloor",
        ...
        folder(
            ...
            [
                ...
                req("单元-2修改", "POST", "/unit.updateUnit",
                    body={"unitId": "{{caseUnitId}}", "unitNum": "9", "layerCount": 8}),
                req("单元-3删除", "POST", "/unit.deleteUnit",
                ...
                req("报修-4删除", "POST", "/repair.deleteRepair",
                    body={"repairId": "{{caseRepairId}}"}),
                ...
                req("投诉-3删除", "POST", "/complaint.deleteComplaint",
                    body={"complaintId": "{{caseComplaintId}}"}),
        ...
        folder(
            ...
            [
                ...
                req("房屋-2修改", "POST", "/room.updateRoom",
                ...
                req("房屋-4退房", "POST", "/room.exitRoom",
                    body={"roomId": "{{caseRoomId}}", "ownerId": OWNER}),
                req("房屋-5删除", "POST", "/room.deleteRoom",
        ...
        folder(
            ...
            [
                ...
                req("业主-2修改", "POST", "/owner.editOwner",
                ...
                req("家庭-3删除成员", "POST", "/owner.deleteOwner",
                    body={"memberId": "{{caseMemberId}}"}),
                req("业主-3删除", "POST", "/owner.deleteOwner",
        ...
        folder(
            ...
            [
                ...
                req("费用项-2修改", "POST", "/feeConfig.updateFeeConfig",
                ...
                req("账单-3结束费用", "POST", "/fee.deleteFee",
                    body={"feeId": "{{caseFeeId}}"}),
                req("费用项-3删除", "POST", "/feeConfig.deleteFeeConfig",
                ...
                req("抄表-2修改", "POST", "/meterWater.updateMeterWater",
                    body={"waterId": "{{caseWaterId}}", "curDegrees": 130}),
                req("抄表-3删除", "POST", "/meterWater.deleteMeterWater",
