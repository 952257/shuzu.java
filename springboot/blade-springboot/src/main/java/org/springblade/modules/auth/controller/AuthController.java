...
public class AuthController {
	...
	public R<AuthInfo> token(@Parameter(description = "授权类型", required = true) @RequestParam(name = "grantType", defaultValue = "password", required = false) String grantType,
							 @RequestParam(name = "grant_type", required = false) String grantTypeAlias,
							 ...
							 @Parameter(description = "账号") @RequestParam(name="username",required = false) String account,
							 @Parameter(description = "密码") @RequestParam(required = false) String password) {

		if (Func.isNotBlank(grantTypeAlias)) {
			grantType = grantTypeAlias;
		}
...
//		return R.data(TokenUtil.createAuthInfo(new UserInfo()));
	}
