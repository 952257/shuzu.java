...
public class UserController {
	...
	public R<IPage<UserVO>> list(@Parameter(hidden = true) @RequestParam Map<String, Object> user,
								 Query query,
								 BladeUser bladeUser) {
	...
	public R<IPage<User>> userList(Query query) {
		IPage<User> pages = Condition.getPage(query);
		UserMapper mapper = (UserMapper) userService.getBaseMapper();
		List<User> records = mapper.selectUserListAll(pages);
